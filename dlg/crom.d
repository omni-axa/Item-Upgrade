  IF ~~ THEN BEGIN c2itemupgrade
    ...
    IF ~PartyHasItem("ring06")~ THEN REPLY @12342 GOTO rop1
    IF ~PartyHasItem("ring07")~ THEN REPLY @12343 GOTO rop2
    ...
    IF ~PartyHasItem("sw1h51")~ THEN REPLY @123427 GOTO cf
    ...
    IF ~PartyHasItem("amul14")~ THEN REPLY @123437 GOTO ilmater
    IF ~PartyHasItem("sw1h52")~ THEN REPLY @123438 GOTO water
    IF ~PartyHasItem("ax1h10")~ THEN REPLY @123439 GOTO azur
    IF ~PartyHasItem("ring08")~ THEN REPLY @123484 GOTO sorcerian
  ...
  IF ~~ THEN BEGIN sorcerian
    SAY @123481 IF ~~ THEN REPLY @123435 GOTO c2itemupgrade
