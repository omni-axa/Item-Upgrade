  ...
  IF ~~ THEN BEGIN c2itemupgrade // from: 151.1 151.0 2.1 2.0
    ...
    IF ~PartyHasItem("ring06")~ THEN REPLY @56782 GOTO rop1
    IF ~PartyHasItem("ring07")~ THEN REPLY @56783 GOTO rop2
    ...
    IF ~PartyHasItem("sw1h51")~ THEN REPLY @567827 GOTO cf
    ...
    IF ~PartyHasItem("amul14")~ THEN REPLY @567837 GOTO ilmater
    IF ~PartyHasItem("sw1h52")~ THEN REPLY @567838 GOTO water
    IF ~PartyHasItem("ax1h10")~ THEN REPLY @567839 GOTO azur
    IF ~PartyHasItem("ring08")~ THEN REPLY @567891 GOTO sorcerian
  ...
  IF ~~ THEN BEGIN rop1
    ...
    IF ~PartyHasItem("ring06") PartyHasItem("ring31") PartyHasItem("misc42")
        PartyGoldGT(9999)~
      THEN REPLY @567836 
  ...
  IF ~~ THEN BEGIN rop2
    ...
    IF ~PartyHasItem("ring07") PartyHasItem("ring31") PartyHasItem("misc42")
        PartyGoldGT(19999)~
      THEN REPLY @567836 
  ...
  IF ~~ THEN BEGIN robe
    ...
    IF ~PartyHasItem("clck15") PartyHasItem("clck01") 
      ...
      DO ~TakePartyGold(20000)      DestroyGold(20000)
          ...
          CreateVisualEffect("spcrtwpn",[401.348])~ EXIT
    IF ~PartyHasItem("clck19") PartyHasItem("clck01") 
        PartyHasItem("scrl7u") PartyHasItem("scrl5k")
        PartyGoldGT(19999)~
      THEN REPLY @123456 
      DO ~TakePartyGold(20000)      DestroyGold(20000)
          ...
          GiveItemCreate("c2robe01",Player1,1,1,1)
          CreateVisualEffect("spcrtwpn",[401.348])~ EXIT
    IF ~PartyHasItem("clck16") PartyHasItem("clck01") 
        PartyHasItem("scrl7u") PartyHasItem("scrl5k")
        PartyGoldGT(19999)~
      THEN REPLY @123457 
      DO ~TakePartyGold(20000)      DestroyGold(20000)
          ...
          CreateVisualEffect("spcrtwpn",[401.348])~ EXIT
    IF ~PartyHasItem("clck17") PartyHasItem("clck01") 
        PartyHasItem("scrl7u") PartyHasItem("scrl5k")
        PartyGoldGT(19999)~
      THEN REPLY @123458 
      DO ~TakePartyGold(20000)      DestroyGold(20000)
  ...
  IF ~~ THEN BEGIN cf
    ...
    IF ~PartyHasItem("sw1h51") PartyHasItem("misc6m") PartyHasItem("wand07")
        PartyGoldGT(19999)~
      THEN REPLY @567836 
      DO ~TakePartyGold(20000)      DestroyGold(20000)
  ...
  IF ~~ THEN BEGIN sorcerian
    SAY @567890 = @5678990  IF ~~ THEN REPLY @567835 GOTO c2itemupgrade
    IF ~PartyHasItem("ring08") PartyHasItem("ring40") 
        PartyHasItem("ring06") PartyHasItem("amul16")
        PartyGoldGT(19999)~
      THEN REPLY @567836 
      DO ~TakePartyGold(20000)      DestroyGold(20000)
